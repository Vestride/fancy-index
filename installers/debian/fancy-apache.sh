...
checkCollision $documentRoot

# Copy the access file
echo "Copying required files..."
cp "${path}/${FANCY_INDEX_HTACCESS_FILENAME}" "${documentRoot}/${FANCY_INDEX_HTACCESS_FILENAME}"

# Add entry to virtualhost
writeDirectoryRules $vhost $path $documentRoot
